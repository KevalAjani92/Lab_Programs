...
SELECT S.RNO,S.NAME,S.BRANCH,R.SPI FROM STU_INFO AS S  JOIN RESULT AS R ON S.RNO = R.RNO WHERE S.BRANCH = 'CE';
...
SELECT S.BRANCH,AVG(R.SPI) AS AVG_SPI FROM STU_INFO AS S  JOIN RESULT AS R ON S.RNO = R.RNO GROUP BY S.BRANCH;

-- 10. Display average result of CE and ME branch.

SELECT S.BRANCH,AVG(R.SPI) AS AVG_SPI FROM STU_INFO AS S  JOIN RESULT AS R ON S.RNO = R.RNO WHERE S.BRANCH IN ('CE','ME') GROUP BY S.BRANCH;
